...
class LaserScan:
    ...
    def __init__(self, project=False, H=64, W=1024, fov_up=3.0, fov_down=-25.0, DA=False,
                 flip_sign=False, rot=False, drop_points=False, use_normal=False, bev_residual_data=None):
        ...
        self.bev_residual_data = bev_residual_data
    ...
    def open_scan(self, filename, from_pose, to_pose, if_transform=True):
        ...
        if self.drop_points is not False:
            ...
            self.bev_residual_data = np.delete(self.bev_residual_data, self.points_to_drop, axis=0)
...
class SemLaserScan(LaserScan):
    ...
    def __init__(self, sem_color_dict=None, project=False,
                 ...
                 DA=False, flip_sign=False, drop_points=False, use_normal=False, bev_residual_data=None):
